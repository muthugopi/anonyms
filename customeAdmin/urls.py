...
from .views import ShowAllUsers, ApproveUser, InvestigateUser, DeleteUser, PromoteToModeratorView
urlpatterns = [
    ...
    path('users/<int:id>/promotetomoderator', PromoteToModeratorView.as_view(), name='user-promotetomoderator')
]